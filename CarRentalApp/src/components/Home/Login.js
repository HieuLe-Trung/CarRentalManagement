    ...
    const handleLoginPress = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const userInfoResponse = await fetch(`${baseURL}user/current_user/`, {
                    method: 'GET',
                    headers: {
                ...
                if (userInfo.is_staff) {
                    navigation.navigate('HomeEmp', { token: accessToken });
                } else {
                    navigation.navigate('HomeDrawer', { token: accessToken });
                }
            } else {
